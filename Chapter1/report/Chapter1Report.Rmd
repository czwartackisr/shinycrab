...
B90ClassCrab$Lifestage <- factor(B90ClassCrab$Lifestage, levels = 
                              c("Juvenile", "Subadult", "Adult", 
                                "Immature Female", "Immature Male", 
                                "Mature Female", "Mature Male",
                                "Sublegal", "Legal"))
...
B90MatureFemale = ggplot(aes(Year, CPUE), data = subset(B90Crab,
...
lm(formula = Year ~ CPUE, data = subset(B90ClassCrab, Lifestage == "Immature Female"))
lm(formula = Year ~ CPUE, data = subset(B90ClassCrab, Lifestage == "Mature Female"))
lm(formula = Year ~ CPUE, data = subset(B90ClassCrab, Lifestage == "Immature Male"))
lm(formula = Year ~ CPUE, data = subset(B90ClassCrab, Lifestage == "Mature Male"))
lm(formula = Year ~ CPUE, data = subset(B90ClassCrab, Lifestage == "Sublegal"))
lm(formula = Year ~ CPUE, data = subset(B90ClassCrab, Lifestage == "Legal"))
...
lm(formula = Year ~ CPUE, data = subset(T38ClassCrab, Lifestage == "Immature Female"))
lm(formula = Year ~ CPUE, data = subset(T38ClassCrab, Lifestage == "Mature Female"))
lm(formula = Year ~ CPUE, data = subset(T38ClassCrab, Lifestage == "Immature Male"))
lm(formula = Year ~ CPUE, data = subset(T38ClassCrab, Lifestage == "Mature Male"))
lm(formula = Year ~ CPUE, data = subset(T38ClassCrab, Lifestage == "Sublegal"))
lm(formula = Year ~ CPUE, data = subset(T38ClassCrab, Lifestage == "Legal"))
