...
***Questions***
 SHOULD I LOG TRANFORM Habor Trawl IF, MF, AND MM?
 Should I LOG Transform Creek Trawl JUVENILEs, and IF, MF AND MM?
...
```{r Figure 2 (CRMS Survey Time Series), echo=FALSE, message=FALSE, warning=FALSE,dpi=600, fig.cap="Mean annual blue crab (total catch) CPUE (mean ± standard error) for all SCDNR Crustacean Section fisheries independent surveys, including Harbor Trawl (A), Creek Trawl (B), and Ashley River Potting Survey (C).", fig.width=10,fig.height=11}

CRMSCPUETimeSeries <- plot_grid(B90TotalCPUE, T38TotalCPUE, P88FallTotalCPUE, ncol = 1, align = 'hv', labels = c("A", "B", "C")) 
CRMSCPUETimeSeries

```


```{r Figure 3 (SCECAP and Trammel Net Time Series), echo=FALSE, message=FALSE, warning=FALSE,dpi=600, fig.cap="Mean annual blue crab (total catch) CPUE (mean ± standard error) from SCDNR non-CRMS  fisheries independent surveys, including SCECAP Open Water Trawl (A), SCECAP Tidal Creek Trawl (B), and the Inshore Fisheries Trammel Net survey", fig.width=10,fig.height=11}

OtherCPUETimeSeries <- plot_grid(E99TotalCPUE, E98TotalCPUE, T06TotalCPUE, ncol = 1, align = 'hv', labels = c("A", "B", "C"))

OtherCPUETimeSeries
```                                                        

```{r Figure 4 (Harbor Trawl Size Time Series), echo=FALSE, include=FALSE, message=FALSE, warning=FALSE,dpi=600, fig.cap="Harbor Trawl survey mean annual blue crab abundance (CPUE) by size (mean ± standard error) for all sites within the Charleston Harbor watershed.  Juvenile CPUEs (A), Subadult CPUEs (B) and Adult CPUEs (C) are shown.  Adult mean annual CPUEs were logarithmically transformed to help aid in visual scaling.", fig.width=10,fig.height=11}
B90Crab = crab %>%
...
B90SizeTimeSeries <- plot_grid(B90Juv, B90Subadult, B90Adult, ncol = 1, align = 'hv', labels = c("A", "B", "C"))
B90SizeTimeSeries
```


```{r Figure 5 (Harbor Trawl Legal-Size Time Series), echo=FALSE, include=FALSE, message=FALSE, warning=FALSE,dpi=600, fig.cap="Harbor Trawl survey mean annual blue crab abundance (CPUE) by legal-size (mean ± standard error) for all sites within the Charleston Harbor watershed.  Sublegal (<127mm carapace width) CPUEs (A), and legal (>126mm carapace width) CPUEs (B) are shown.", fig.width=10,fig.height=11}
...
B90LegalTimeSeries <- plot_grid(B90Sublegal, B90Legal, ncol = 1, align = 'hv', labels = c("A", "B"))
B90LegalTimeSeries
```

```{r Figure 6 (Harbor Trawl sex Maturity Time Series), echo=FALSE, include=FALSE, message=FALSE, warning=FALSE,dpi=600, fig.cap="Harbor Trawl survey mean annual blue crab abundance (CPUE) by sex and maturity class (mean ± standard error) for all sites within the Charleston Harbor watershed.  Immature female CPUEs (A), mature Female CPUEs (B), mature male CPUEs (C) and mature male CPUEs (D) are shown.",fig.width=10,fig.height=12}
...
```{r Figure 7 (Creek Trawl Size Time Series), echo=FALSE, include=FALSE, message=FALSE, warning=FALSE,dpi=600, fig.cap="Creek Trawl survey mean annual blue crab abundance (CPUE) by size (mean ± standard error) for all sites within the Charleston Harbor watershed.  Juvenile CPUEs (A), Subadult CPUEs (B) and Adult CPUEs (C) are shown.", fig.width=10,fig.height=11}
T38Crab = crab %>%
...
T38SizeTimeSeries <- plot_grid(T38Juv, T38Subadult, T38Adult, ncol = 1, align = 'hv', labels = c("A", "B", "C"))
T38SizeTimeSeries
```

```{r Figure 8 (Creek Trawl Legal-Size Time Series), echo=FALSE, include=FALSE, message=FALSE, warning=FALSE,dpi=600, fig.cap="Creek Trawl survey mean annual blue crab abundance (CPUE) by legal-size (mean ± standard error) for all sites within the Charleston Harbor watershed.  Sublegal (<127mm carapace width) CPUEs (A), and legal (>126mm carapace width) CPUEs (B) are shown.", fig.width=10,fig.height=11}
...
T38LegalTimeSeries <- plot_grid(T38Sublegal, T38Legal, ncol = 1, align = 'hv', labels = c("A", "B"))
T38LegalTimeSeries
```

```{r Figure 9 (Creek Trawl Sex and Maturity Time Series), echo=FALSE, include=FALSE, message=FALSE, warning=FALSE,dpi=600, fig.cap="Creek Trawl survey mean annual blue crab abundance (CPUE) by sex and maturity class (mean ± standard error) for all sites within the Charleston Harbor watershed.  Immature female CPUEs (A), mature Female CPUEs (B), mature male CPUEs (C) and mature male CPUEs (D) are shown.", fig.width=10,fig.height=12}
#I have to make a separate data frame here due to poor subset performance
...
```{r Figure 10 (Ashley Potting Survey Size Time Series), echo=FALSE, include=FALSE, message=FALSE, warning=FALSE,dpi=600, fig.cap="Ashley Potting Survey mean annual blue crab abundance (CPUE) by legal-size (mean ± standard error) for all sites within the Charleston Harbor watershed.  Sublegal (<127mm carapace width) CPUEs (A), and legal (>126mm carapace width) CPUEs (B) are shown.", fig.width=10,fig.height=11}
P88Crab = crab %>%
  filter(ProjID == "Ashley Potting") %>%
...
```{r Figure 11 (SCECAP Tidal Creek Trawl Time Series), echo=FALSE, include=FALSE, message=FALSE, warning=FALSE,dpi=600, fig.cap="SCECAP Tidal Creek Trawl survey mean annual blue crab abundance (CPUE) by size (mean ± standard error) for all sites within the Charleston Harbor watershed.  Juvenile CPUEs (A), Subadult CPUEs (B) and Adult CPUEs (C) are shown.  Tidal Creeks within the Charleston Harbor watershed were not sampled in 2009, 2011, 2013 or 2014.", fig.width=10,fig.height=11}
E98Crab = crab %>%
...
```{r Figure 12 (SCECAP Tidal Creek Trawl Legal-Size Time Series), echo=FALSE, include=FALSE, message=FALSE, warning=FALSE,dpi=600, fig.cap="SCECAP Tidal Creek Trwal survey mean annual blue crab abundance (CPUE) by legal-size (mean ± standard error) for all sites within the Charleston Harbor watershed.  Sublegal (<127mm carapace width) CPUEs (A), and legal (>126mm carapace width) CPUEs (B) are shown.  Tidal Creeks within the Charleston Harbor watershed were not sampled in 2009, 2011, 2013 or 2014.", fig.width=10,fig.height=11}
...
```{r Figure 13 (SCECAP Tidal Open Water Time Series), echo=FALSE, include=FALSE, message=FALSE, warning=FALSE,dpi=600, fig.cap="SCECAP Open Water Trawl survey mean annual blue crab abundance (CPUE) by size (mean ± standard error) for all sites within the Charleston Harbor watershed.  Juvenile CPUEs (A), Subadult CPUEs (B) and Adult CPUEs (C) are shown.  No Open Water SCECAP sampling occured in 2008.", fig.width=10,fig.height=11}
E99Crab = crab %>%
...
```{r Figure 14 (SCECAP Tidal Open Water Trawl Legal-Size Time Series), include=FALSE, echo=FALSE, message=FALSE, warning=FALSE,dpi=600, fig.cap="Ashley Potting Survey mean annual blue crab abundance (CPUE) by legal-size (mean ± standard error) for all sites within the Charleston Harbor watershed.  Sublegal (<127mm carapace width) CPUEs (A), and legal (>126mm carapace width) CPUEs (B) are shown.  No Open Water SCECAP sampling occured in 2008.", fig.width=10,fig.height=11}
