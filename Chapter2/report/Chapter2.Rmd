...
```{r Figure 4, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Mean Annual Blue Crab CPUE ~ Cooper River and Survey Salinity metrics"}

CooperT38 <- ggplot(aes(PSU, CPUE), data = subset(crab, 
                                               Watershed == "Cooper" &
                                               Lifestage == "Total" &
                                               ProjID == "T38")) +
  ggtitle("T38 CPUEs ~ Cooper River Salinities") +
  geom_point() +
  geom_smooth(method="lm") +
